...
// 5. Pass down callback method for saving question number + question text + answer for each question as states
// 5a. Save all data in local storage and DB when user presses 'Næste'
